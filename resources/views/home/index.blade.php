@extends('layouts.default', ['title' => 'Cedric AGOSSOU - Coach professionnel, Entrepreneur et Motivateur'])
...
@section('content')
    ...
    <section class="home-section">
        <video src="{{asset('app/images/SearchLeeds 2018 Official Event Video.mp4')}}>" autoplay muted loop class="w-100 d-none d-md-block"></video>
    ...
    <section class="section-about">
        <div class="col-12">
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        <img src="{{asset('app/images/IMG-20181212-WA0094.jpg')}}" class="img-fluid w-100"/>
                    </div>
                </div>
            ...
            <div class="col-md-4 box1">
                <div class="row" style="background-color: rgba(0,0,0,0.7); height: 300px;">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <a href="{{route('formation')}}" class="btn btn-outline-light mx-auto wow fadeInUp">EN SAVOIR PLUS</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 box2">
                <div class="row" style="background-color: rgba(0,0,0,0.7); height: 300px;">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <a href="{{route('coaching')}}" class="btn btn-outline-light mx-auto wow fadeInUp">EN SAVOIR PLUS</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 box3">
                <div class="row" style="background-color: rgba(0,0,0,0.7); height: 300px;">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <a href="{{route('event')}}" class="btn btn-outline-light mx-auto wow fadeInUp">EN SAVOIR PLUS</a>
                        </div>
                    </div>
                </div>
            </div>
